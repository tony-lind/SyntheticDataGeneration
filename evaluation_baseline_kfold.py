...
print('?-training RF model using baseline embeddings') 
rf_model = RandomForestClassifier(n_jobs=-1)

print("?-do experiment")
p_dict =  test_data(rf_model, X, y)

print("?-writing results to file")
f = open('result_baseline','a')
...
pickle.dump(p_dict, open('result_no_syn', 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
